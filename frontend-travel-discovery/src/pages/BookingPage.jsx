...
import { Plane, Hotel, User, MapPin, CreditCard, Loader, Bus } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-md p-6 sticky top-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="border-t pt-4">
                                        <div className="flex justify-between mb-2">
                                            ...
                                            <span className="text-sm font-medium text-gray-900">{item.origin} → {item.destination}</span>
                                        </div>
                                        <div className="flex justify-between mb-2">
                            ...
                            ) : type === 'bus' || item.category_id === 'BUS' ? (
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        <Bus className="h-6 w-6 text-orange-600 mr-3 mt-1" />
                                        <div className="flex-1">
                                            <p className="font-semibold text-gray-900">{item.descriptor?.name || 'Bus Operator'}</p>
                                            <p className="text-sm text-gray-600">{item.descriptor?.short_desc || 'Bus Service'}</p>
                                        </div>
                                    </div>
                                    <div className="border-t pt-4">
                                        <div className="flex justify-between mb-2">
                                        ...
                                        <div className="flex justify-between mb-2">
                                            ...
                                            <span className="text-sm font-medium text-gray-900">
                                                {item.time?.timestamp ? new Date(item.time.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : 'N/A'}
                                            </span>
                                        </div>
                                        <div className="flex justify-between mb-2">
                                            <span className="text-sm text-gray-600">Seat(s)</span>
                                            <span className="text-sm font-medium text-gray-900">1 Seat</span>
                                        </div>
                                    </div>
                                </div>
                            ) : (
