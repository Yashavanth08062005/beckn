  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-5xl mx-auto -mt-20 relative z-10">
      ...
      <form onSubmit={handleSubmit}>
        {searchData.transportMode === "flight" || searchData.transportMode === "bus" ? (
          /* Flight & Bus Search Fields */
        ...
        >
          ...
          <span>Search {searchData.transportMode === "flight" ? "Flights" : searchData.transportMode === "hotel" ? "Hotels" : "Buses"}</span>
        </button>
      </form>
    </div>
  );
